...
if __name__ == '__main__':
    ...
    if dataset == 'ibugs':
        ...
        # silence_dir_path   = '/data/jfmadrig/amicorpus/5fold_valid_Silence/CV2/IS1002b/video/Closeup1/'
        ...
        # speaker_dir_path   = '/data/jfmadrig/amicorpus/5fold_valid_Speaking/CV2/IS1002b/video/Closeup1/'
        # train_outpu_file = 'lists/amicorpus/train_heads_list_binary.txt'
        # test_outpu_file  = 'lists/amicorpus/test_heads_list_binary.txt'
        silence_train_output = 'lists/amicorpus/Silence/train_heads_list_wholeshortV2.txt'
        silence_test_output  = 'lists/amicorpus/Silence/test_heads_list_wholeshortV2.txt'
        silence_dir_path   = '/data/jfmadrig/amicorpus/5fold_valid_wholeshort_v2_Silence/'
        speaker_train_output = 'lists/amicorpus/Speaking/train_heads_list_wholeshortV2.txt'
        speaker_test_output  = 'lists/amicorpus/Speaking/test_heads_list_wholeshortV2.txt'
        speaker_dir_path   = '/data/jfmadrig/amicorpus/5fold_valid_wholeshort_v2_Speaking/'
        train_outpu_file = 'lists/amicorpus/train_heads_list_wholeshortV2.txt'
        test_outpu_file  = 'lists/amicorpus/test_heads_list_wholeshortV2.txt'

        silence_train_output = 'lists/amicorpus/Silence/train_heads_list_cv4.txt'
        silence_test_output  = 'lists/amicorpus/Silence/test_heads_list_cv4.txt'
        speaker_train_output = 'lists/amicorpus/Speaking/train_heads_list_cv4.txt'
        speaker_test_output  = 'lists/amicorpus/Speaking/test_heads_list_cv4.txt'
        train_outpu_file = 'lists/amicorpus/train_heads_list_cv4.txt'
        test_outpu_file  = 'lists/amicorpus/test_heads_list_cv4.txt'
