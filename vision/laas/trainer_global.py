...
def main():
    ...
    if args.train_file is None:
        # ### ibug-avs heads
        args.train_file = 'lists/ibug-avs/v1/train_heads_list_angle_c10.txt'
        args.test_file  = 'lists/ibug-avs/v1/test_heads_list_angle_c10.txt'
        #
        ...
        #### lr-vid-ict lips
        # args.train_file = 'lists/train_lips_list_lr-vid-ict.txt'
        # args.test_file  = 'lists/test_lips_list_lr-vid-ict.txt'

        # V2
        # args.train_file = 'lists/ibug-avs/train_heads_list_angle_c10_v2_bis.txt'
        # args.test_file  = 'lists/ibug-avs/test_heads_list_angle_c10_v2_bis.txt'
        # args.train_file = 'lists/ibug-avs/train_heads_list_angle_c2_v2.txt'
        # args.test_file  = 'lists/ibug-avs/test_heads_list_angle_c2_v2.txt'

    if args.save_path is None:
        # ### ibug-avs heads
        args.save_path = 'weights/ibugs/siamese/heads_angles_v2_optflow/'
        #### lr-vid-ict lips
        # args.save_path = 'weights/lr-vid-ict/siamese/lips_Scaled/'
    ...
    args.save_path = args.save_path + '/' + args.net_video + '_' + args.net_audio + '/' + 'C' + str(num_classes) + 'E' + str(args.epochs) + conf + '/'
...
def train_model(args):
    ...
    if 'resnet3D_18' == args.net_video:
        model, generator_train_batch, generator_val_batch, generator_test_batch = m.r3d_18(args.num_classes)
    elif 'resnet3D_34' == args.net_video:
        model, generator_train_batch, generator_val_batch, generator_test_batch = m.r3d_34(args.num_classes)
    elif 'resnet2D_concat' == args.net_video:
        model, generator_train_batch, generator_val_batch, generator_test_batch = m.r2d_50(args.num_classes)
    elif 'C3D' == args.net_video:
        model, generator_train_batch, generator_val_batch, generator_test_batch = m.c3d(args.num_classes)
    elif 'sC3D' == args.net_video:
        model, generator_train_batch, generator_val_batch, generator_test_batch = m.siamese_c3d(args.num_classes)
    elif 'sresnet3D_18' == args.net_video:
        model, generator_train_batch, generator_val_batch, generator_test_batch = m.siamese_r3d_18(args.num_classes)
    elif 'sresnet3D_34' == args.net_video:
        model, generator_train_batch, generator_val_batch, generator_test_batch = m.siamese_r3d_34(args.num_classes)
    else:
