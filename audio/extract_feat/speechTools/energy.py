...
def getFrequencyBean ( frequency, spectralBase ):
	...
	This function returns the index of the spectral base where the frequency bean center is just higher than the given frequency. If all the bean centers are lower than the given frequency, the spectral base size is returned.
